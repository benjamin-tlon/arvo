...
++  hoon                                                ::
  =>  |%                                                ::REVIEW
      ...
      ++  tuna                                          ::  maybe interpolation
          $^(manx {?($tape $manx $marl $cnhp) p/hoon})  ::
      --                                                ::
  $^  {p/hoon q/hoon}                                   ::
  $%                                                    ::
    {$$ p/axis}                                         ::  simple leg
  ::                                                    ::
    ...
    {$help p/what q/hoon}                               ::  annotate with help
    {$hilt p/hoon q/hoon}                               ::  annotate with build
...
++  type  $@  $?  $noun                                 ::  any nouns
          ...
          $%  {$atom p/term q/(unit @)}                 ::  atom / constant
              ...
              {$help p/what q/type}                     ::  text documentation
              {$hilt p/hoon q/type}                     ::  build documentation
...
++  ut
  ...
  ++  mull
    ...
    ::
        {$hilt *}
      =+(vat=$(gen q.gen) [(hilt p.gen p.vat) (hilt p.gen q.vat)])
    ::
        {$ktsg *}  $(gen p.gen)
        {$sgzp *}  ~_(duck(sut (play p.gen)) $(gen q.gen))
        {$sggr *}  $(gen q.gen)
...
++  vast
  ...
  ::
  ++  poof  |=(pax/path ^-((list hoon) (turn pax |=(a/@ta [%sand %ta a]))))
  ++  poon
    |=  {pag/(list hoon) goo/tyke}
    ^-  (unit (list hoon))
    ?~  goo  `~
    %+  both
  ...
  ++  cram                                              ::  parse unmark
    =>  |%
        ...
        ++  colm  @ud                                   ::  column
        ++  flow  marl:hoon                             ::  node or generator
        ++  mite                                        ::  context
          $?  $down                                     ::  outer embed
